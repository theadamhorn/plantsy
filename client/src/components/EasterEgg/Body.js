        ...
        <main className="thanksBody container-fluid text-center">
            ...
            <animated.div style={Text} className="row justify-content-evenly m-1">
                ...
                <div className="col-sm-6 col-md-6 col-lg-6 d-flex justify-content-center Adam"><div className="col-sm-10 col-md-10 col-lg-10 Text">
                    <p>Hey you! I’m Adam. Yes, THAT Adam of Team Plantsy! It has been a great experience developing this application and hope that gardeners everywhere can benefit from this platform as they care for their plant babies. Having come from a career in legislative politics, earning my MBA in Finance, building a plant-focused app was never something I’d be involved in but wouldn’t have it any other way! Thanks to all of you at Team Plantsy!</p>
                    <p>- Adam</p>
                    <p><a className="Links" target="_blank" href="https://theadamhorn.github.io/portfolio/index.html">Adam's Profile Page</a></p>
