    ...
    return (
        <main className="thanksBody container-fluid text-center">
             ...
             <div className="row align-items-center">
                 <div className="col-sm-2 col-md-2 col-lg-2 "></div><animated.div style={Alex} className="col-sm-8 col-md-8 col-lg-8"><img className="Alex" src="./css/images/alex.png"/></animated.div><div className="col-sm-2 col-md-2 col-lg-2 "></div>
            </div>
             ...
             <div className="row justify-content-around">
                 <div className="col-sm-1 col-md-1 col-lg-1 "></div>
                    <div className="col-sm-4 col-md-4 col-lg-4">
                        <animated.div style={Ryan} className="col"><img className="Ryan" src="./css/images/ryan.png"/></animated.div>
                 ...
                 <div className="col-sm-1 col-md-1 col-lg-1 "></div>
                    <div className="col-sm-5 col-md-5 col-lg-5">
                        <animated.div style={Zac} className="col"><img className="Zac" src="./css/images/Zac.png"/></animated.div>
